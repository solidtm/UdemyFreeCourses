...
val PrimaryCardColors = CardColors(
    containerColor = primaryContainerLight,
    contentColor = onPrimaryContainerLight,
    disabledContentColor = onPrimaryContainerLight,
    disabledContainerColor = primaryContainerLight
)


val PrimarySolidColors = CardColors(
...
val GlassCardColors = CardColors(
    containerColor = primaryContainerLight.copy(alpha = 0.65f),
    contentColor = onPrimaryContainerLight,
    disabledContentColor = onPrimaryContainerLight,
    disabledContainerColor = primaryContainerLight.copy(alpha = 0.65f),
)

val HighlightCardColors = CardColors(
    containerColor = tertiaryContainerLight,
    contentColor = onTertiaryLight,
    disabledContentColor = onTertiaryContainerLight,
    disabledContainerColor = onTertiaryLight
)

val DisabledCardColors = CardColors(
    containerColor = surfaceVariantDark,
    contentColor = onSurfaceVariantDark,
    disabledContentColor = surfaceVariantDark,
    disabledContainerColor = onSurfaceVariantDark
)